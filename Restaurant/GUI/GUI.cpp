...
void GUI::PrintMessage(string msg, int x, int y) const	//Prints a message on status bar
{
	pWind->SetPen(BLACK);
...
void GUI::Removedrawing(Order *ptr)
{
	int c = 0;
	for (int i = 0; i < OrderCount; i++)
	{
